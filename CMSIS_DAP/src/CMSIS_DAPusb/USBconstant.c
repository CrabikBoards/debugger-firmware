...
__code uint8_t SerDes[]={                                 //Serial String Descriptor
    0x14,0x03,
    'C',0x00,'r',0x00,'a',0x00,'b',0x00,'i',0x00,'k',0x00,
    '_',0x00,'r',0x00,'B',0x00
};
__code uint16_t SerDesLen = sizeof(SerDes);
__code uint8_t Prod_Des[]={                                //Produce String Descriptor
    0x22,0x03,
    'C',0x00,'r',0x00,'a',0x00,'b',0x00,'i',0x00,'k',0x00,
    ' ',0x00,'C',0x00,'M',0x00,'S',0x00,'I',0x00,'S',0x00,
    '-',0x00,'D',0x00,'A',0x00, 'P',0x00
};
__code uint16_t Prod_DesLen = sizeof(Prod_Des);

__code uint8_t Manuf_Des[]={
    0x18,0x03,
    'A',0x00,'m',0x00,'p',0x00,'e',0x00,'r',0x00,'k',0x00,
    'a',0x00,' ',0x00,'L',0x00,'L',0x00,'C',0x00
};
